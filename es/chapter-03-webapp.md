...
![Creación del proyecto](chapter-03/01_new_project.png)
...
![Selección del tipo de proyecto](chapter-03/02_project_webapp.png)

Seleccionamos la ruta en la que se guardará el proyecto. Recordad que no se pueden usar espacios o caracteres con acentos.

![Ruta del proyecto](chapter-03/03_project_folder.png)

Escribimos los datos de la aplicación.

![Datos del paquete click](chapter-03/04_project_click.png)
...
![Selección de los Kits](chapter-03/05_project_kit.png)
...
![Resumen del proyecto](chapter-03/06_project_brief.png)

Ya hemos acabado el asistente. El proyecto se abre de forma automática.

![Proyecto que se ha creado en el asistente](chapter-03/07_project_open.png)
...
![Archivo .excludes](chapter-03/08_project_excludes.png)
...
![Archivo manifest.json](chapter-03/09_project_manifest.png)

* _WebApp.apparmor:_ permisos de la aplicación.

![Archivo WebApp.apparmor](chapter-03/10_project_apparmor.png)

* _WebApp.desktop:_ información para lanzar la aplicación en el scope de aplicaciones.

![Archivo WebApp.desktop](chapter-03/11_project_desktop.png)

* _WebApp.png:_ icono de la aplicación.

![Archivo WebApp.png](chapter-03/12_project_icon.png)
...
![Ejecución de la aplicación en el escritorio](chapter-03/13_webapp_desktop.png)
...
![Ejecución de la aplicación en el dispositivo](chapter-03/14_weapp_device.png)
...
![Compilación del paquete click](chapter-03/15_click_build.png)
...
![Instalación del paquete click](chapter-03/16_click_install.png)

El resultado es la aplicación instalada en el dispositivo.

![Aplicación en el scope de aplicaciones](chapter-03/17_app_scope.png)
...
![Inicio de sesión para publicar la aplicación](chapter-03/18_app_shop.png)

Pulsamos en el enlace y accederemos al panel de control.

![Panel de control de la Ubuntu Store](chapter-03/19_app_snap.png)
...
![Datos del usuario 1/3](chapter-03/20_app_data_01.png)

![Datos del usuario 2/3](chapter-03/21_app_data_02.png)

![Datos del usuario 3/3](chapter-03/22_app_data_03.png)
...
![Nombre de la aplicación](chapter-03/23_package_name.png)
...
![Características de la aplicación 1/2](chapter-03/24_app_info.png)

![Características de la aplicación 2/2](chapter-03/25_app_info_02.png)
...
![Ficha inicial de la aplicación](chapter-03/26_publish_01.png)

En la pestaña General definimos el nombre de la aplicación y escribimos un resumen de una línea.

![Pestaña general](chapter-03/27_publish_02.png)
...
![Pestaña discovery](chapter-03/28_publish_03.png)
...
![Pestaña presentation](chapter-03/29_publish_04.png)
...
![Pestaña license and support](chapter-03/30_publish_05.png)
...
![Búsqueda de la aplicación en la tienda de  Ubuntu](chapter-03/33_store_01.png)

![Ficha de la aplicación en la tienda de Ubuntu](chapter-03/34_store_02.png)

La aplicación también aparece en uApp de forma automática.

![Ficha de la aplicación en uApp Explorer](chapter-03/35_uapp.png)
