...
![Comparación entre los dos diseños](chapter-04-s06/01-comparison.png)
...
![Creación del nuevo archivo QML](chapter-04-s06/02-new-file.png)
* Escribir el nombre del archivo.
![Selección del nombre](chapter-04-s06/03-file-name.png)
* Pulsar el botón Finish.
![Resumen](chapter-04-s06/04-brief.png)
...
![Diseño de la pantalla de resultados](chapter-04-s06/05-display-component.png)
...
![Boceto de la pantalla de resultados](chapter-04-s06/06-display-draw.png)
...
![Diseño del botón personalizado](chapter-04-s06/07-button-component.png)

El esquema del botón es el siguiente:

![Boceto del botón personalizado](chapter-04-s06/08-button-draw.png)
...
Los *** se tienen que sustituir por el código adecuado.
...
**Ejercicio: sustituir los botones iniciales del bloque básico por el botón personalizado.**
Ejemplo:
...
![Diseño del bloque básico](chapter-04-s06/09-basic-calculator.png)

**Ejercicio: hacer lo mismo para el bloque de la calculadora científica.**

![Diseño del bloque científico](chapter-04-s06/10-scientific-calculator.png)
