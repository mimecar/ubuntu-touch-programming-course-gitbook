...
![Archivos del proyecto de la aplicación](chapter-05-s02/01_application_source.png)
...
![Pantalla de configuración de la aplicación](chapter-05-s02/02_application.png)

Al aceptar (o actualizar) la configuración que propone la aplicación se llegará a la nueva pantalla inicial:

![Nuevo diseño de la pantalla inicial](chapter-05-s02/03_application_new_design.png)
...
![Pantalla de analítica](chapter-05-s02/04_chart.png)
